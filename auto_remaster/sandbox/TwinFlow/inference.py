...
model_path = "/code/auto_remaster/sandbox/TwinFlow/src/outputs/TwinFlow-Z-Image-Turbo/TwinFlow-Z-Image-Turbo-exp"
...
model = ZImage(model_path, aux_time_embed=True, device=device).to(device)
...
# hf download inclusionAI/TwinFlow-Z-Image-Turbo --local-dir ./src/outputs/TwinFlow-Z-Image-Turbo
