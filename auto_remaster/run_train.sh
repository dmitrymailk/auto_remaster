...
hf_train_config=/code/auto_remaster/configs/lbm_train_test_gap_gan.yaml
...
accelerate launch --config_file=$config_path -m auto_remaster.train_auto_remaster_lbm_train_test_gap_gan --config $hf_train_config
