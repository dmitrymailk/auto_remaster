...
CONTROLNET = None
STEPS = 1
# PROMPT = "best quality, realistic, unreal engine, 4K, a beautiful cat"
...
INPUT_IMAGE = None
CONTROL_IMAGE = None
OUTPUT_IMAGE = "/code/inference_optimization/stable_fast/test.jpg"
...
from diffusers import EulerAncestralDiscreteScheduler, LCMScheduler, AutoencoderTiny
...
def parse_args():
    ...
    parser.add_argument("--tiny-vae", type=str, default=TINY_VAE)
    parser.add_argument(
        "--compiler",
        type=str,
        default="sfast",
...
def load_model(
    ...
    model = pipeline_cls.from_pretrained(
        model, torch_dtype=torch.float16, **extra_kwargs
    )
